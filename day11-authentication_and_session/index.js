...
db.connect(function (err, client, done) {
  ...
  app.post("/myproject", (req, res) => {
    let add = req.body;
    // console.log(add);
    let queryAdd = `INSERT INTO tb_projects(name, start_date, end_date, description, technologies, image) 
      VALUES ('${add.InputName}','${add.startdate}','${add.enddate}','${add.description}','{"${add.nodejs}","${add.reactjs}","${add.angular}","${add.vuejs}"}','${add.uploadimage}');`;
